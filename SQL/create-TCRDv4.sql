...
INSERT INTO `disease_type` VALUES ('DisGeNET','Currated disease associations from DisGeNET (http://www.disgenet.org/)'),('DrugCentral Indication','Disease indications and associated drug names from Drug Central.'),('Expression Atlas','Target-Disease associations from Expression Atlas where the log2 fold change in gene expresion in disease sample vs reference sample is greater than 1.0. Only reference samples \"normal\" or \"healthy\" are selected. Data is derived from the file: ftp://ftp.ebi.ac.uk/pub/databases/microarray/data/atlas/experiments/atlas-latest.html-data.tar.gz'),('JensenLab Experiment COSMIC','JensenLab Experiment channel using COSMIC'),('JensenLab Experiment DistiLD','JensenLab Experiment channel using DistiLD'),('JensenLab Knowledge GHR','JensenLab Knowledge channel using GHR'),('JensenLab Knowledge UniProtKB-KW','JensenLab Knowledge channel using UniProtKB-KW'),('JensenLab Text Mining','JensenLab Text Mining channel'),('UniProt Disease','Disease association from UniProt comment field with type=\"disease\"');
